...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
          <h3 class="card-title">Kategori Barang <button type="button" data-toggle="modal" data-target="#modal-default" class="btn btn-block btn-success btn-sm float-end"><i class="bi bi-plus-square"></i> Kategori</button></h3>
