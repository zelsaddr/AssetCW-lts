...
<head>
  ...
  <title>@yield('title', 'Dashboard - CW Asset CMS')</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ url('assets/img/CW.png') }}" rel="icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="{{ url('assets/img/CW.png') }}" alt="">
        <span class="d-none d-lg-block">CW Assets CMS</span>
      </a>
  ...
  <main id="main" class="main">
    ...
    {{-- <div class="pagetitle text-end">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item text-end"><a href="index.html">Home</a></li>
